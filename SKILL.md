...
4. **Python 依赖安装**：`pip install -r requirements.txt`
...
```bash
python3 scripts/auto_lit.py "theta EEG FDG PET" --screen --min-relevance 4 -m 0 -n 20 -c "电波 > theta" -t theta-metabolic-coupling
```
